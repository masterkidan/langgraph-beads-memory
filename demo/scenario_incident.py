...
INCIDENT_SYSTEM_PROMPT = (
    ...
    "- Only delegate to your investigator sub-agents when the user explicitly "
    "asks you to investigate.\n"
    "- If the user is only reporting symptoms, correcting a detail, or asking a "
    "question you can answer from your Memory context, do NOT delegate and do "
    "NOT call read_document. Acknowledge briefly, record what matters with "
    "remember_fact, and stop.\n"
